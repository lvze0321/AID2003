-- MySQL dump 10.day13  Distrib 5.7.29, for Linux (x86_64)
--
...
INSERT INTO `cls` VALUES (1,'Lily','w',19,86),(2,'Tom','m',18,69),(3,'Eva','w',17,79),(4,'Tony','m',20,92),(5,'Abby','w',18,91),(6,'Baron','m',18,86);
...
INSERT INTO `dept` VALUES (1,'技术部'),(2,'销售部'),(3,'市场部'),(4,'行政部'),(5,'财务部');
...
INSERT INTO `good_stu` VALUES (4,'Tony','m',20,92),(5,'Abby','w',18,91),(6,'Baron','m',18,86);
...
INSERT INTO `interest` VALUES (1,'Lily','sing,dance',28888,NULL,'骨骼惊奇，练武奇才'),(2,'Joy','sing',15000,NULL,NULL),(3,'Lucy','dance',8000,NULL,NULL);
...
INSERT INTO `marathon` VALUES (1,'尼古拉斯赵四','1990-01-01','2019-10-28 10:10:10','02:58:43'),(2,'奥利给','1991-12-07','2019-12-21 11:10:10','02:35:day13'),(3,'曹操','1996-04-02','2020-02-02 11:10:10','02:22:43'),(4,'小泽','1996-08-08','2020-05-07 14:09:28','02:22:43');
...
INSERT INTO `person` VALUES (1,'Lily',29,'w',20000.00,'2017-04-03',NULL),(2,'Tom',27,'m',16000.00,'2019-10-03',1),(3,'Joy',30,'m',28000.00,'2016-04-03',1),(4,'Emma',24,'w',8000.00,'2019-05-08',4),(5,'Abby',28,'w',17000.00,'2018-11-03',3),(6,'Jame',32,'m',22000.00,'2017-04-07',3),(7,'Alex',21,'m',4000.00,'2019-09-16',5);
...
/*!50001 VIEW `good_student` AS select `cls`.`id` AS `id`,`cls`.`name` AS `name`,`cls`.`age` AS `age`,`cls`.`score` AS `score` from `cls` where (`cls`.`score` > 80) */;
...
-- Dump completed on 2020-05-11 16:15:02
